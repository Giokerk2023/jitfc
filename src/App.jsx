...
import StakeholderManager from './components/stakeholder/StakeholderManager';  // Add this import
    ...
    <BrowserRouter>
      <div>
        <nav className="bg-gray-800 text-white p-4">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            <div className="flex gap-4">
              ...
              <Link to="/stakeholders" className="hover:text-blue-300">Stakeholder Test</Link>
              <Link to="/manage" className="hover:text-blue-300">Manage Stakeholders</Link>
            </div>
          </div>
        </nav>
        ...
        <Routes>
          ...
          <Route path="/manage" element={<StakeholderManager />} />
